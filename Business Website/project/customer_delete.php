...
try {     
    ...
    //check whether customer has order
    $query_1 = "SELECT * FROM order_summary WHERE customer_id = ?";
    ...
    if ($num > 0) {
        ...
        $delete_image="SELECT image from customer WHERE id = ?";
